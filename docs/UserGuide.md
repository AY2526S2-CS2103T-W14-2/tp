...
4. **Support for special characters and spaces in a customer's phone number**: You will be able to enter phone numbers containing alphabets, special characters and spaces (e.g. `9876 5432 (HP) 6560-6060 (Office)`). This allows you to specify multiple phone numbers for a customer.
